...
\begin{table}[h]
\centering
\begin{tabular}{l | p{0.21\linewidth} | p{0.5\linewidth}}
      & UC function & UC set \\\hline\hline
    1 & $x^n$ & $\left\{  x^n, x^{n-1}, x^{n-2}, \cdots, x, 1 \right\} $ \\\hline
    2 & $e^{ax}$ & $\left\{ e^{ax} \right\}$ \\\hline
    3 & $\sin{(bx+c)}$ or $\cos{(bx+c)}$ & $\left\{ \sin{(bx+c)}, \cos{(bx+c)}\right\} $ \\\hline
    4 & $x^ne^{ax}$ & $\left\{ x^ne^{ax}, x^{n-1}e^{ax}, x^{n-2}e^{ax}, \cdots, xe^{ax}, e^{ax} \right\}$ \\\hline
    5 & $x^n\sin{(bx+c)}$ or $x^n\cos{(bx+x)}$ & $\{ x^n\sin{(bx+c)}, x^n\cos{(bx+c)},$ $x^{n-1}\sin{(bx+c)}, x^{n-1}\cos{(bx+c)},$ $\cdots, x\sin{(bx+c)}, x\cos{(bx+c)},$ $\sin{(bx+c)}, \cos{(bx+c)} \} $ \\\hline
    6 & $e^{ax}\sin{(bx+c)}$ or $e^{ax}\cos{(bx+c)}$ & $\left\{ e^{ax}\sin{(bx+c)}, e^{ax}\cos{(bx+c)} \right\}$ \\\hline
    7 & $x^ne^{ax}\sin{(bx+c)}$ or $x^ne^{ax}\cos{(bx+x)}$ & $\{ x^ne^{ax}\sin{(bx+c)}, x^ne^{ax}\cos{(bx+c)},$ $x^{n-1}e^{ax}\sin{(bx+c)}, x^{n-1}e^{ax}\cos{(bx+c)},$ $\cdots, xe^{ax}\sin{(bx+c)}, xe^{ax}\cos{(bx+c)},$ $e^{ax}\sin{(bx+c)}, e^{ax}\cos{(bx+c)} \} $ \\\hline
\end{tabular}
\end{table}
