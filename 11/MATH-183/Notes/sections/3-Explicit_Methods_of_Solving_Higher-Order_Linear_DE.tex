...
\end{equation}
will be a particular integral of (3.4.1). We can write \[
...
\begin{equation*}
    ...
    \end{split}
\end{equation*}
Since $y_1$ and $y_2$ are solutions of (3.4.2), we get \[
...
\end{equation}
Therefore, a particular integral $y_p$ of (3.4.1) is defined by \[
    y_p = v_1(x)y_1(x) + v_2(x)y_2(x)
\] where $v_1$ and $v_2$ are defined by (3.4.4).
