...
\underline{\textbf{Definition ($\epsilon-\delta$ version):}}
...
\]
Likewise,\footnote{
    $\delta$-neighbourhood: $ U_\delta(a) = \{x \in \mathbb{R} : |x-a| < \delta \} = (a-\delta, a+\delta) $
}
\[
    |x-c|<\delta \iff x \in U_\delta(x)
\]
\underline{\textbf{Definition (Topological Version):}}
...
\begin{minipage}{0.9\textwidth}
    \textbf{Ex 1: (i) If $f(x) = 3x+1$, prove that $ \lim_{x \to 2} f(x) = 7 $}
    ...
    \textbf{Ex 2: From the definition of $(\delta,\epsilon)$ show that $\lim_{x \to 3} (2x^3-3x^2-18x+29)=2$}
